...
with_node \
  ...
  --target "/Users/lucasmartinez/Desktop/react-native-mobile/ios/Pods/Target Support Files/Pods-grupo8mobile/ExpoModulesProvider.swift" \
  --entitlement "/Users/lucasmartinez/Desktop/react-native-mobile/ios/grupo8mobile/grupo8mobile.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-asset" "expo-blur" "expo-constants" "expo-dev-launcher" "expo-dev-menu" "expo-file-system" "expo-font" "expo-haptics" "expo-image" "expo-keep-awake" "expo-linking" "expo-maps" "expo-secure-store" "expo-splash-screen" "expo-symbols" "expo-system-ui" "expo-web-browser"
